...
description: "Synthetic router for task trackers, mail, knowledge systems, and publishing surfaces."
license: Apache-2.0
---

# Connected Systems Router
...
- system-specific reads, writes, permissions, and read-back verification.

## Neighbor boundary

- Authentication implementation belongs to the tooling-platforms router.
...
For the included fixture, the example target is `tracker-triage`. See the [generated route map](../../generated-route-map.md).

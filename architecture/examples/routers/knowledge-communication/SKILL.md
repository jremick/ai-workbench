...
description: "Synthetic router for research, synthesis, writing, and communication."
license: Apache-2.0
---

# Knowledge And Communication Router
...
- source-backed research, synthesis, briefs, and audience-aware writing.

## Neighbor boundary

- Formatted documents and reports belong to the artifact-production router.
...
For the included fixture, the example target is `evidence-brief`. See the [generated route map](../../generated-route-map.md).

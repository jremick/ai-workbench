...
description: "Synthetic router for durable agent instructions, decisions, context, and workflow governance."
license: Apache-2.0
---
...
- decision records, context orientation, reusable workflow governance.

## Neighbor boundary

- Engineering implementation belongs to the engineering-delivery router.
...
For the included fixture, the example target is `decision-journal`. See the [generated route map](../../generated-route-map.md).
